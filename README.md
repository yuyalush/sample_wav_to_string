...
- `/tmp/workspace/yuyalush/sample_wav_to_string/transcribe_compare.py`: 本体CLI
- `/tmp/workspace/yuyalush/sample_wav_to_string/requirements.txt`: 依存関係
- `/tmp/workspace/yuyalush/sample_wav_to_string/tests/test_compare.py`: 比較ロジックのユニットテスト
- `/tmp/workspace/yuyalush/sample_wav_to_string/samples/sample.wav`: サンプルWAV（16kHz/モノラル/16bit）
